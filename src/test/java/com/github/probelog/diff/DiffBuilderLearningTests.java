...
public class DiffBuilderLearningTests {
    ...
    public void simpleInsert() {
        ...
        assertEquals("[INSERT,,~~I~~Insert One Line~~I~~]", diffRow.toString());
    ...
    public void simpleUpdate() {
        ...
        assertEquals("[CHANGE,~~D~~before~~D~~ ~~D~~1234~~D~~,~~I~~after~~I~~ ~~I~~6789~~I~~]", diffRow.toString());
    ...
    public void complex() {
        ...
        assertEquals("[INSERT,,~~I~~1.1~~I~~]", diffRows.get(1).toString());
        ...
        assertEquals("[CHANGE,4 ~~D~~5~~D~~,4 ~~I~~6~~I~~]", diffRows.get(5).toString());
    ...
    public void javaExamples() {
        ...
        assertEquals("[CHANGE,private int ~~D~~field1;~~D~~,private int ~~I~~field2;~~I~~]", diffRow.toString());
    ...
    public void replacingBlankLines() {
        ...
        assertEquals("[CHANGE, ,~~I~~not~~I~~ ~~I~~blank~~I~~]", diffRow.toString());

        List<DiffRow> diffRows = expectTwoDiffRows(asList(" ", " "), asList("not blank"));
        assertEquals("[CHANGE,~~D~~ ,~~I~~not blank~~I~~]", diffRows.get(0).toString());
        assertEquals("[CHANGE, ~~D~~,]", diffRows.get(1).toString());

        diffRows = expectThreeDiffRows(asList(" ", " ", " "), asList("not blank"));
        assertEquals("[CHANGE,~~D~~ ,~~I~~not blank~~I~~]", diffRows.get(0).toString());
        assertEquals("[CHANGE, ,]", diffRows.get(1).toString());
        assertEquals("[CHANGE, ~~D~~,]", diffRows.get(2).toString());
